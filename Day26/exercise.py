...
# EXERCISE 05 - Use Dictionary Comprehension to create a dictionary called weather_f that takes each temperature in degree Celcius and converts it to Farenheit.
